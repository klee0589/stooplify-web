    ...
    <>
      ...
      <AnimatePresence>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={handleOpen} className="bg-[#14B8FF] text-white rounded-full fixed z-50 w-[62px] h-[62px] shadow-2xl flex items-center justify-center hover:bg-[#0da3e6] transition-colors"
