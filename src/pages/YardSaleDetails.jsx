            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100">
              ...
              <div className="flex gap-2">
                <motion.a
                  ...
                  className="flex-1 flex items-center justify-center gap-2 px-3 py-2.5 bg-[#1877F2] hover:bg-[#0e64d1] text-white rounded-xl font-semibold text-sm transition-colors"
                >
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-2 px-3 py-2.5 bg-black hover:bg-gray-800 text-white rounded-xl font-semibold text-sm transition-colors"
                >
                ...
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-2 px-3 py-2.5 bg-[#25D366] hover:bg-[#1da851] text-white rounded-xl font-semibold text-sm transition-colors"
                >
